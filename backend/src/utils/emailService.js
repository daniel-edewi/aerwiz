    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: #ffffff; padding: 40px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          ...
          <p style="color: #4b5563;">Hi ${user.firstName}, your flight has been booked successfully.</p>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: #ffffff; padding: 40px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          ...
          <p style="color: #4b5563; text-align: center;">Hi ${user.firstName}, your payment of <strong>${formatPrice(booking.totalAmount)}</strong> has been received.</p>
